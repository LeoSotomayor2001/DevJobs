...
<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-50 my-10 p-4">
            <p class="font-bold text-sm uppercase text-gray-700 my-3">Empresa:
                <span class="normal-case font-normal">{{$vacante->empresa}}</span>
            </p>

            <p class="font-bold text-sm uppercase text-gray-700 my-3">Último dia para postularse:
            ...
            <p class="font-bold text-sm uppercase text-gray-700 my-3">Salario:
