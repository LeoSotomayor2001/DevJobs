    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    @can('create', App\Model\Vacante::class)
                        <a href="{{route('notificaciones')}}" class="mr-2 flex flex-col justify-center items-center w-7 h-7 bg-indigo-600
                        hover:bg-indigo-800 rounded-full text-white font-extrabold text-sm" title="Notificaciones">
            ...
            <div class="pt-2 pb-3 space-y-1">
                ...
                @if(auth()->user()->rol ===2)
                    <div class="flex gap-2 items-center p-3">
                        <a href="{{route('notificaciones')}}" class="flex flex-col justify-center items-center w-7 h-7 bg-indigo-600
                        hover:bg-indigo-800 rounded-full text-white font-extrabold text-sm" title="Notificaciones">
                            {{Auth::user()->unreadNotifications->count()}}
